...
export const description = [
  'Đầu tư luôn hàm chứa những rủi ro có thể kể đến như rủi ro mất đi các khoản đầu tư, rủi ro về tính thanh khoản , khoản đầu tư có thể bị pha loãng...',
  'Đầu tư luôn hàm chứa những rủi ro có thể kể đến như rủi ro mất đi các khoản đầu tư, rủi ro về tính thanh khoản , khoản đầu tư có thể bị pha loãng... Vui lòng tham khảo chi tiết nội dung mục "Cảnh báo về rủi ro đầu tư" trước khi thực hiện đầu tư chỉ nên thực hiện khi nhà đầu tư nhận thức rõ ràng rủi ro hàm chứa.',
  'Đầu tư luôn hàm chứa những rủi ro có thể kể đến như rủi ro mất đi các khoản đầu tư, rủi ro về tính thanh khoản , khoản đầu tư có thể bị pha loãng... Vui lòng tham khảo chi tiết nội dung mục "Cảnh báo về rủi ro đầu tư" trước khi thực hiện đầu tư chỉ nên thực hiện khi nhà đầu tư nhận thức rõ ràng rủi ro hàm chứa.',
...
export const header2 = [
  '+ Đầu tư vay vốn có phổ biến tại Việt Nam ?',
  '+ Ai là người có thể đầu tư ?',
  '+ Người nước ngoài có thể đầu tư được không ?',
  '+ Có hạn chế số tiền đầu tư không ?'
];
